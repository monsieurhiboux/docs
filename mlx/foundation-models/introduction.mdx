...
<Note>
Foundation Models donne accès au modèle de langage système d'Apple via le module `FoundationModels`. Votre app n'embarque pas elle-même les poids du modèle. Vérifiez toujours la disponibilité au runtime.
</Note>
